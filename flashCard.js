...
var BasicCard = require("./deck/basicCard");
...
function playRound(currentScore, cardArray, currentIndex) {
  // Goes through each card until we have gone through all of them
...
function promptUser(cardArray, currentIndex, currentScore) {
  // Store the current card in a VAR
  ...
  inquirer.prompt([{
    ...
    // Checking to see if their answer was correct, regardless of casing by .toLower
